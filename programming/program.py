...
appAddrNeeded = False
appAddr = '0x18000'
bootloaderStr = 'binaries/rigdfu2_nrf51_s110_rel_3_2_0.hex'
...
if args.savemac:
	if device == 'NRF52832_XXAA':
		print('Warning: MAC address cannot be saved on BMD-300 due to readback protection!')
		mac = jlink.make_mac_bin('ffffffffffff', None)
	else:
